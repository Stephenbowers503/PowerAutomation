...
class CWICOB(CTfWorkload):
    _DEFAULT_NAME = 'ICOB'
    _DEFAULT_NUM_OF_RETRIES = 1
    _DEFAULT_TRIGGER = '0'
    _DEFAULT_TIME_OUT_SEC = 800
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWICOB, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWICOB, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call(r'cmd /c C:\python36\lib\site-packages\evtar\maple\workloads\ICOB\Run_Icob.bat')
        except:
            self._Logger.Info("Didn't Start ICOB")
