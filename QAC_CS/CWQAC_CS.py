...
class CWQAC_CS(CTfWorkload):
    _DEFAULT_NAME = 'QAC_CS'
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWQAC_CS, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWQAC_CS, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\QAC_CS\Run_CS.bat'])
        except:
