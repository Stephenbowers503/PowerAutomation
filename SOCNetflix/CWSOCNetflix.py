...
#
# Name:        CWSOCNetflix 
# Purpose:     Collect socwatch data for 800p VPB and transfer to host.
#
# Author:      tcase & jfrankm (converted to Maple3 by rsher) Repurposed/edited by sbowers
#
# Created:     17-Mar-2015, edited 1/21/2022
# -------------------------------------------------------------------------------
...
class CWSOCNetflix(CTfWorkload):
    _DEFAULT_NAME = 'SOCNetflix'
    ...
    def _ParamsCreate(cls):
        return dict(super(CWSOCNetflix, cls)._ParamsCreate(),
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWSOCNetflix, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWSOCNetflix, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\SOCNetflix\Run_Netflix.bat'])
        except:
