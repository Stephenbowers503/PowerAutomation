...
class CW1080p(CTfWorkload):
    _DEFAULT_NAME = 'vp1080p'
    ...
    def _ParamsCreate(cls):
        return dict(super(CW1080p, cls)._ParamsCreate(),
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CW1080p, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CW1080p, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\1080p\Run_1080p.bat'])
        except:
