 ...
 python "C:\python36\lib\site-packages\evtar\maple\workloads\QAC_Idle\Unplug_USB.pyw"
...
python "C:\python36\lib\site-packages\evtar\maple\workloads\QAC_idle\Plug_In_USB.pyw"
for($b = 0; $b -ne 100; $b++)
         {
