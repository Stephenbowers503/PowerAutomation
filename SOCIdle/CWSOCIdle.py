...
class CWSOCIdle(CTfWorkload):
    _DEFAULT_NAME = 'SOCIdle'
    ...
    def _ParamsCreate(cls):
        return dict(super(CWSOCIdle, cls)._ParamsCreate(),
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWSOCIdle, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWSOCIdle, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\SOCIdle\Run_Idle.bat'])
        except:
