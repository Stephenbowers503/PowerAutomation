...
class CWWifi(CTfWorkload):
    ...
    def _ParamsCreate(cls):
        return dict(super(CWWifi, cls)._ParamsCreate(),
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWWifi, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWWifi, self)._AfterSubWorkload(subWorkload, currentIteration)
