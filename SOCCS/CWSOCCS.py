...
class CWSOCCS(CTfWorkload):
    _DEFAULT_NAME = 'SOC_CS'
    _DEFAULT_NUM_OF_RETRIES = 1
    _DEFAULT_TRIGGER = '0'
    _DEFAULT_TIME_OUT_SEC = 99999.0
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWSOCCS, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWSOCCS, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
                subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\SOCCS\Run_CS.bat'])
        except:
