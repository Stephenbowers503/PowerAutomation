...
class CWWaitIdle(CTfWorkload):
    _DEFAULT_NAME = 'WaitIdle'
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWWaitIdle, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWWaitIdle, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        status = ''
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\15MIN_idle\Run_Idle.bat'])
        except:
