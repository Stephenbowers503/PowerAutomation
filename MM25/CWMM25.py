...
class CWMM25(CTfWorkload):
    _DEFAULT_NAME = 'MM25'
    _DEFAULT_NUM_OF_RETRIES = 1
    _DEFAULT_TRIGGER = '0'
    _DEFAULT_TIME_OUT_SEC = 7000.0
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWMM25, self)._BeforeSubWorkload(subWorkload)
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\MM25\Run_MM25.bat'])
        except:
            self._Logger.Info("Didn't open automation files")

    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWMM25, self)._AfterSubWorkload(subWorkload, currentIteration)
