...
class CWPerformance(CTfWorkload):
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWPerformance, self)._BeforeSubWorkload(subWorkload)
        ...
        try:
            Communicator.ExecuteCommandOnTarget(r'C:\users\Administrator\Documents\TransferToSUT\Autofiles\Power_Profiles\Performance.vbs')
        except:
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWPerformance, self)._AfterSubWorkload(subWorkload, currentIteration)
