...
class CW800p(CTfWorkload):
    _DEFAULT_NAME = 'vp800p'
    ...
    def _ParamsCreate(cls):
        return dict(super(CW800p, cls)._ParamsCreate(),
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CW800p, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CW800p, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\800p\Run_800p.bat'])
        except:
