...
class CWNetflix(CTfWorkload):
    ...
    def _BeforeSubWorkload(self, subWorkload):
        super(CWNetflix, self)._BeforeSubWorkload(subWorkload)
    ...
    def _AfterSubWorkload(self, subWorkload, currentIteration):
        super(CWNetflix, self)._AfterSubWorkload(subWorkload, currentIteration)
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            subprocess.call([r'C:\python36\lib\site-packages\evtar\maple\workloads\Netflix\Run_Netflix.bat'])
        except:
