Start "C:\Program Files (x86)\BAPCo\SecurityTool\SecurityTool.exe"
cmd /c C:\Users\Local_Admin\Documents\TransferToSut\autofiles\Dut_Side\Security_tool2.vbs

Timeout 20

Start "C:\Program Files (x86)\BAPCo\MobileMark25\Bin\MobileMark 25.exe"
...
Get-Process 'MobileMark 25' | Set-Window -X 1 -Y 1 -Passthru
    Timeout 10

[system.Reflection.Assembly]::LoadWithPartialName("System.Windows.Forms") | out-null
    Add-Type -MemberDefinition '[DllImport("user32.dll")] public static extern void mouse_event(int flags, int dx, int dy, int cButtons, int info);' -Name U32 -Namespace W;
    [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point(2192,1747);

    [W.U32]::mouse_event(6,0,0,0,0);

    Timeout 5

    [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point(2827,498);
    ...
    [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point(2860,1073);

    [W.U32]::mouse_event(6,0,0,0,0);

    Timeout 5

     [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point(233,433);
    ...
    Taskkill /F /IM 'MobileMark 25.exe'
