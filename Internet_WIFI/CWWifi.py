...
class CWWifi(CTfWorkload):
    ...
    def _RunSubWorkloadSyncOrAsync(self, subWorkload):
        ...
        try:
            Communicator.ExecuteCommandOnTarget(r'c:\tools\elevate\elevate.exe -c powershell C:\Users\Local_Admin\Documents\TransferToSut\autofiles\dut_Side\wifi_Internet.ps1')
        except:
